...
class TicketLog(Base):
    ...
    kind: Mapped["LogType"]
    by: Mapped[str]
    at: Mapped[datetime.datetime] = mapped_column(default=datetime.datetime.utcnow())
...
class TicketParticipant(Base):
    ...
    taken_at: Mapped[datetime.datetime] = mapped_column(default=datetime.datetime.utcnow())
...
class Ticket(Base):
    ...
    participants: Mapped[List["TicketParticipant"]] = relationship("TicketParticipant", back_populates="ticket", cascade="all, delete-orphan")
